...
*   **Brand Presentation:** Swipable onboarding carousel showcasing *Form Platoons*, *Exclusive Deals*, and *Curated Trips*.
...
*   **Preferences Capture:** Checklist of travel styles: *Adventure/Trekking*, *Heritage/Culture*, *Leisure/Beach*, *Backpacker*, *Wellness/Yoga*. Used for feed personalization.
...
*   **Categorized List:** Tabs separating *Featured*, *Adventure*, *Heritage*, *Beach*, *Budget*. Powered by `Shopify Flash-List` for 60FPS scroll efficiency.
...
### 4.3 Platoon (Group) System — *Core Logic*
*   **Joining Platoons:** 
...
*   **Metric Grid:** Displays *Total Journeys*, *Active Platoons*, *Savings Accumulated (₹)*, and *Completed Trips*.
